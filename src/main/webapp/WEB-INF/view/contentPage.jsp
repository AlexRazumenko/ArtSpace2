...
<b>ID: <c:out value="${currentContent.id}" />  Type: <c:out value="${currentContent.type.name()}" /><br>
            ...
            <form:form action="/addContent" method="post" modelAttribute="newContent">
